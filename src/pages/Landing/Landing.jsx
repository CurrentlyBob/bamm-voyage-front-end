...
import andreaTravel from '../../assets/images/andreaTravel.jpg'
        ...
        <main className={styles.loggedInBackground}>
          <div className={styles.landingContainer}>
            ...
            <div className={styles.aboutUs}>
              ...
              <p>
                BAMM Voyage was built by a group of coders with a passion for
                traveling. Altogether they have visited over 50 countries! They
                saw the struggle in finding a good travel planning app, thus
                BAMM Voyage was born.
              </p>
            </div>
